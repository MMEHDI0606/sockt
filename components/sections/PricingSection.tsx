...
const TIERS = [
  {
    ...
    ram: '256 MB',
    satsPerSecond: '0.5',
    borderStyle: '1px solid var(--bg-border)',
  ...
  },
  {
    ...
    ram: '1 GB',
    satsPerSecond: '2',
    borderStyle: '1px dashed var(--accent-amber)',
  ...
  },
  {
    ...
    ram: '4–8 GB',
    satsPerSecond: '4',
    borderStyle: '2px solid var(--bg-border)',
  ...
  },
  {
    ...
    ram: '16 GB',
    satsPerSecond: '8',
    borderStyle: '1px solid var(--accent-btc)',
    accentColor: 'var(--accent-btc)',
  },
  {
    name: 'A100',
    vcpu: '8 + A100',

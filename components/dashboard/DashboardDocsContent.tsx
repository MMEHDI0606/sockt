...
export default function DashboardDocsContent() {
          ...
          <div className="space-y-8 mt-6">
            ...
            <div className="border border-[var(--dashboard-border)] rounded-lg p-5 bg-[var(--dashboard-card)]">
              <div className="flex items-center gap-3 mb-3">
                <span className="font-mono text-xs bg-[rgba(194,122,54,0.15)] text-[var(--dashboard-accent)] px-2.5 py-1 rounded font-semibold">GET</span>
                <span className="font-mono text-sm font-semibold">/v1/sandboxes/tiers</span>
              </div>
              <p className="text-xs text-[var(--dashboard-muted)] mb-4">List all sandbox hardware sizes, credit billing rates (cents/sec), Lightning billing rates (msats/sec), and cost estimates.</p>
              <div className="font-mono text-[10px] text-[var(--dashboard-muted)] uppercase tracking-[0.08em] mb-2">Response Example (200 OK)</div>
              <CodeBlock code={`{
    ...
    },
    {
      ...
      "cost_per_hour_usd": 0.02
            ...
            <div className="border border-[var(--dashboard-border)] rounded-lg p-5 bg-[var(--dashboard-card)]">
              ...
              <p className="text-xs text-[var(--dashboard-muted)] mb-4">Provision a new secure compute sandbox environment. Requires API Key bearer for credits billing, or runs anonymously for Lightning billing.</p>
              <div className="font-mono text-[10px] text-[var(--dashboard-muted)] uppercase tracking-[0.08em] mb-2">Request Body (JSON)</div>
              <CodeBlock code={`{
  "tier": "nano",
  ...
  "prepaid_sats": 5000           // optional satoshis prepay (lightning only)
              ...
              <div className="font-mono text-[10px] text-[var(--dashboard-muted)] uppercase tracking-[0.08em] mb-2">Response Example (201 Created — Lightning)</div>
              <CodeBlock code={`{
  ...
  "expires_at": "2026-05-29T16:00:00Z"
              ...
              <div className="font-mono text-[10px] text-[var(--dashboard-muted)] uppercase tracking-[0.08em] mb-2">Response Example (201 Created — Credits)</div>
              <CodeBlock code={`{
  "ID": "sb_9f8a3d2e1c0b",
  "Status": "pending",
  ...
  "UserID": "usr_abc123"
            ...
            <div className="border border-[var(--dashboard-border)] rounded-lg p-5 bg-[var(--dashboard-card)]">
              ...
              <p className="text-xs text-[var(--dashboard-muted)] mb-4">Retrieve current sandbox metadata, status state, metric logs, warning levels, and Lightning top-up invoice states.</p>
              <div className="font-mono text-[10px] text-[var(--dashboard-muted)] uppercase tracking-[0.08em] mb-2">Query Parameters</div>
              <ul className="list-disc pl-5 text-xs text-[var(--dashboard-muted)] mb-3 space-y-1">
  ...
  "runtime_consumed_total": 500000
            ...
            <div className="border border-[var(--dashboard-border)] rounded-lg p-5 bg-[var(--dashboard-card)]">
              ...
              <p className="text-xs text-[var(--dashboard-muted)] mb-4">Start asynchronous execution of a command. Returns an opaque ID immediately. Buffers outputs to the executions worker.</p>
              <div className="font-mono text-[10px] text-[var(--dashboard-muted)] uppercase tracking-[0.08em] mb-2">Request Body (JSON)</div>
              <CodeBlock code={`{
  ...
  "next_step": "Poll the execution result endpoint using the execution_id"
            ...
            <div className="border border-[var(--dashboard-border)] rounded-lg p-5 bg-[var(--dashboard-card)]">
              ...
              <p className="text-xs text-[var(--dashboard-muted)] mb-4">Poll current stdout/stderr chunks and execution state. Each request consumes and deletes the read buffer, returning only **new** lines since your last poll.</p>
              <div className="font-mono text-[10px] text-[var(--dashboard-muted)] uppercase tracking-[0.08em] mb-2">Query Parameters</div>
              <ul className="list-disc pl-5 text-xs text-[var(--dashboard-muted)] mb-3 space-y-1">
  ...
  "exit_code": 0
            ...
            <div className="border border-[var(--dashboard-border)] rounded-lg p-5 bg-[var(--dashboard-card)]">
              ...
              <p className="text-xs text-[var(--dashboard-muted)] mb-4">Request cancellation of an active, running shell execution. Terminates the underlying process group on the container.</p>
              <div className="font-mono text-[10px] text-[var(--dashboard-muted)] uppercase tracking-[0.08em] mb-2">Response Example (200 OK)</div>
              <CodeBlock code={`{
  "execution_id": "exec_abc123f4g5",
  "status": "cancelled"
            ...
            <div className="border border-[var(--dashboard-border)] rounded-lg p-5 bg-[var(--dashboard-card)]">
              ...
              <p className="text-xs text-[var(--dashboard-muted)] mb-4">Create a new file or completely overwrite an existing file inside the sandboxed container filesystem.</p>
              <div className="font-mono text-[10px] text-[var(--dashboard-muted)] uppercase tracking-[0.08em] mb-2">Request Body (JSON)</div>
              <CodeBlock code={`{
  "path": "eval.py",
  ...
  "created_dirs": false
            ...
            <div className="border border-[var(--dashboard-border)] rounded-lg p-5 bg-[var(--dashboard-card)]">
              ...
              <p className="text-xs text-[var(--dashboard-muted)] mb-4">Read file contents from the sandbox filesystem. Returns raw text or base64 representation.</p>
              <div className="font-mono text-[10px] text-[var(--dashboard-muted)] uppercase tracking-[0.08em] mb-2">Request Body (JSON)</div>
              <CodeBlock code={`{
  "path": "eval.py",
  "encoding": "utf8",         // 'utf8' or 'base64'
  "max_bytes": 100000         // optional byte ceiling
              ...
              <div className="font-mono text-[10px] text-[var(--dashboard-muted)] uppercase tracking-[0.08em] mb-2">Response Example (200 OK — UTF-8)</div>
              <CodeBlock code={`{
  "path": "/home/sandbox/eval.py",
  "size_bytes": 14,
  "encoding": "utf8",
  ...
  "content": "print('hello')"
            ...
            <div className="border border-[var(--dashboard-border)] rounded-lg p-5 bg-[var(--dashboard-card)]">
              ...
              <p className="text-xs text-[var(--dashboard-muted)] mb-4">List files and directories in a given sandbox directory path (single level).</p>
              <div className="font-mono text-[10px] text-[var(--dashboard-muted)] uppercase tracking-[0.08em] mb-2">Query Parameters</div>
              <ul className="list-disc pl-5 text-xs text-[var(--dashboard-muted)] mb-3 space-y-1">
  ...
  "total_entries": 2
            ...
            <div className="border border-[var(--dashboard-border)] rounded-lg p-5 bg-[var(--dashboard-card)]">
              ...
              <p className="text-xs text-[var(--dashboard-muted)] mb-4">Pause execution on the cloud orchestrator. Halts ongoing active billing charges.</p>
              <div className="font-mono text-[10px] text-[var(--dashboard-muted)] uppercase tracking-[0.08em] mb-2">Response Example (200 OK)</div>
              <CodeBlock code={`{
  "sandbox_id": "sb_9f8a3d2e1c0b",
  "status": "paused"
            ...
            <div className="border border-[var(--dashboard-border)] rounded-lg p-5 bg-[var(--dashboard-card)]">
              ...
              <p className="text-xs text-[var(--dashboard-muted)] mb-4">Resume a paused sandbox environment. Restarts container processes and reactivates pricing billing meters.</p>
              <div className="font-mono text-[10px] text-[var(--dashboard-muted)] uppercase tracking-[0.08em] mb-2">Response Example (200 OK)</div>
              <CodeBlock code={`{
  "sandbox_id": "sb_9f8a3d2e1c0b",
  "status": "running"
            ...
            <div className="border border-[var(--dashboard-border)] rounded-lg p-5 bg-[var(--dashboard-card)]">
              ...
              <p className="text-xs text-[var(--dashboard-muted)] mb-4">Permanently terminate the sandbox environment. Deletes container assets. For Lightning billing, returns remaining balance refund details if a refund address is provided.</p>
              <div className="font-mono text-[10px] text-[var(--dashboard-muted)] uppercase tracking-[0.08em] mb-2">Request Body (JSON — Optional)</div>
              <CodeBlock code={`{
  "lightning_address": "agent-sats@wallet.example", // Lightning refund address (Lightning billing only)
  "sandbox_token": ""                               // Alternative token auth
}`} />
              <div className="font-mono text-[10px] text-[var(--dashboard-muted)] uppercase tracking-[0.08em] mb-2">Response Example (200 OK — Lightning with refund)</div>
              <CodeBlock code={`{
  "sandbox_id": "sb_9f8a3d2e1c0b",
  "status": "terminated",
  ...
  "refund": {
    ...
    "address": "agent-sats@wallet.example"
              ...
              <div className="font-mono text-[10px] text-[var(--dashboard-muted)] uppercase tracking-[0.08em] mb-2">Response Example (200 OK — Credits with refund)</div>
              <CodeBlock code={`{
  "sandbox_id": "sb_9f8a3d2e1c0b",
  "status": "terminated",

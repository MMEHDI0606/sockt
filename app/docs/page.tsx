...
const examples = [
  ...
  'Content swarm: builds a weekly content calendar, writes X threads and LinkedIn posts, generates AI video (LTX draft clips → Kling 3.0 final → Shotstack stitch), submits everything to Slack for approval, then publishes to platform APIs.',

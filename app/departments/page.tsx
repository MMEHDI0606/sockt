    ...
    <>
      ...
      <main style={{ minHeight: '100vh', padding: '96px 24px 120px', color: 'var(--text-primary)' }}>
        <div style={{ maxWidth: '1080px', margin: '0 auto' }}>
          ...
          <h1 style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(2.1rem, 6vw, 3.8rem)', lineHeight: 1, letterSpacing: '-0.04em', margin: 0, maxWidth: '13ch' }}>Three departments. One coordinated operating layer.</h1>
